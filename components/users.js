 ...
 * @param {function} callback
 */
SteamCommunity.prototype.getUserInventoryContentsPaginationWithProxy = function(userID, appID, contextID, tradableOnly, language, proxyList, count, startAsset, callback) {
	if (typeof language === 'function') {
		callback = language;
		language = "english";
	}
